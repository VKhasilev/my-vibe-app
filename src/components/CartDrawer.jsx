      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed right-0 top-0 h-full w-full max-w-md glass-strong z-50 shadow-2xl flex flex-col"
          >
            {/* Header */}
                      ...
                      <div className="flex gap-4">
                        <div className="w-20 h-20 rounded-xl bg-gradient-to-br from-indigo-500/20 to-purple-500/20 overflow-hidden flex-shrink-0">
                          <img
                            ...
                            onError={(e) => {
                              e.target.src = `https://via.placeholder.com/80x80/6366f1/ffffff?text=${encodeURIComponent(item.name.substring(0, 2))}`
                            }}
                          />
                        </div>
